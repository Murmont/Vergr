      ...
      <div className="w-full max-w-[400px] flex flex-col h-full justify-between min-h-[700px]">
        <div className="flex flex-col flex-1 mt-10">
          ...
          <div className="mb-10 px-2">
            <h1 className="font-syne text-white tracking-tight text-[36px] font-extrabold leading-tight text-center mb-2">Welcome Back</h1>
            <p className="text-text-secondary text-lg font-medium text-center">Ready to drop in?</p>
          </div>
          <form onSubmit={handleLogin} className="flex flex-col gap-5 px-1">
            ...
            <div className="flex justify-end mt-1">
              <Link to="/forgot-password" className="text-brand-cyan text-sm font-semibold hover:text-white transition-colors">Forgot Password?</Link>
            </div>
          ...
          <div className="flex gap-3 px-1">
            <button onClick={handleGoogleLogin} className="flex-1 h-[52px] rounded-full border border-border-accent bg-surface-2 flex items-center justify-center gap-2 hover:bg-surface-3 transition-all active:scale-[0.98]">
              ...
              <span className="text-text-primary text-sm font-semibold">Google</span>
            </button>
          </div>
        </div>
        <div className="text-center py-6">
          <p className="text-text-secondary text-sm">
            ...
            <Link to="/signup" className="text-brand-cyan font-semibold hover:text-white transition-colors">Sign Up</Link>
          </p>
        </div>
      </div>
    </div>
