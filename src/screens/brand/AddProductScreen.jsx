    ...
    <div className="screen-container min-h-screen flex flex-col">
      ...
      <main className="flex-1 px-5 pb-8 overflow-y-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          <label className="block"><span className="text-text-secondary text-xs font-bold uppercase mb-2 block">Price (EUR)</span><input type="number" value={form.price} onChange={e=>set('price',e.target.value)} className="w-full bg-surface border border-surface-border rounded-xl px-4 py-3 text-white outline-none focus:border-primary"/></label>
