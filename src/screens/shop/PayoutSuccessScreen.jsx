...
export default function PayoutSuccessScreen() {
  ...
  return (
    <div className="screen-container min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <p className="text-text-secondary text-base text-center max-w-[280px] mb-8">Your payout of €48.88 is being processed. You'll receive it within 3-5 business days.</p>
